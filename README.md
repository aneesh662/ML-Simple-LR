...
Streamlit for creating interactive web apps. upload the Experience Salary.csv to link this Check out the live demo of the project [here](https://ml-simple-lr.streamlit.app/).
